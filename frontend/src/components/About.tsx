const About = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
      <div className="max-w-4xl w-full bg-white text-gray-700 rounded-lg shadow-lg p-8 border border-gray-200">
        <h1 className="text-4xl font-bold mb-8 text-gray-800">About OctoCAT Supply</h1>
