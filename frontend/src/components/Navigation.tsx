...
export default function Navigation() {
  ...
  return (
    <nav className="bg-white/95 backdrop-blur-sm fixed w-full z-50 shadow-md">
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0 flex items-center">
            <Link to="/" className="flex items-center">
              ...
              />
              <div className="ml-2">
                <span className="text-xl font-bold text-gray-800">OctoCAT Supply</span>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <Link to="/products" className="text-gray-700 hover:text-primary px-3 py-2 rounded-md text-sm font-medium transition-colors">Products</Link>
              <Link to="/about" className="text-gray-700 hover:text-primary px-3 py-2 rounded-md text-sm font-medium transition-colors">About us</Link>
              {isAdmin && (
